...
mkdir -p "$SHARED/test_requests/cloud_vm" "$SHARED/test_requests/desktop" "$SHARED/test_requests/laptop"
mkdir -p "$SHARED/test_results/cloud_vm" "$SHARED/test_results/desktop" "$SHARED/test_results/laptop"
