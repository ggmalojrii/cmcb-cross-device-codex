...
- Oracle worker handoff consistency audit: queued
  - `shared/CMCB-Shared/test_requests/cloud_vm/test_cloud_vm_handoff_consistency1.json` added as the next cloud VM workspace inventory packet.
